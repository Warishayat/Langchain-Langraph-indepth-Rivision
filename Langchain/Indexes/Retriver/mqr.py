...
#actually this is use when the query is ambigious and not understandle.
...
MQR = MultiQueryRetriever.from_llm(llm=chat_model,retriever=retriver.as_retriever(kwargs={"k":5}))
query = "about page"
res = MQR.get_relevant_documents(query)
print(res)