...
# sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 this model from huggingface



embedding_mod = HuggingFaceEmbeddings(model="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
